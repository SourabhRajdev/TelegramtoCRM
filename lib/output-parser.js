...
const ariaResponseSchema = z.object({
  ...
  reasoning: z.string().describe(
    'MANDATORY. Your internal reasoning chain. Explain: (1) what the user wants, (2) which board(s) are relevant, (3) what entities/filters you identified, (4) what action you chose and why. Must be at least 20 characters. Generic reasoning like "user wants data" is REJECTED.'
  ),
...
function validateAgentOutput(output) {
  ...
  if (!output.reasoning || output.reasoning.length < 20) {
    reasons.push('Reasoning is missing or too short (< 20 chars).');
  }
