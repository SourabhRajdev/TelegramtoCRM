...
const EXAMPLES = [
  ...
  // ── CREATE ITEM ────────────────────────────────────────────
  {
    ...
    output: JSON.stringify({
      ...
      action_type: 'write',
      needs_data: true,
      queries: ['mutation { create_item(board_id: {{SALES_BOARD_ID}}, group_id: \\"{{SALES_GROUP_ID}}\\", item_name: \\"Omar Saeed\\", column_values: \\"{\\\\\\"phone\\\\\\":{\\\\\\"phone\\\\\\":\\\\\\"+971509876543\\\\\\",\\\\\\"countryShortName\\\\\\":\\\\\\"AE\\\\\\"},\\\\\\"source\\\\\\":{\\\\\\"label\\\\\\":\\\\\\"WhatsApp\\\\\\"},\\\\\\"assigned_ae\\\\\\":\\\\\\"Sourabh\\\\\\"}\\") { id name } }'],
